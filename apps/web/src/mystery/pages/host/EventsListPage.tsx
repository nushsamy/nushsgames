...
import { EventStatusBadge } from "@/mystery/components/events/EventStatusBadge";
import { useEventsList } from "@/mystery/hooks/useEventsList";
...
export function EventsListPage() {
  ...
  function controlPath(eventId: number, status: string): string {
    return status === "created" ? `/mystery/host/${eventId}/builder` : `/mystery/host/${eventId}/control`;
  }
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate("/mystery/host/create")}>+ New Mystery</Button>
      </div>
