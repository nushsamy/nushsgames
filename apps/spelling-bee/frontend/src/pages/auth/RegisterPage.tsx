...
export function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[linear-gradient(160deg,oklch(0.97_0.03_340)_0%,oklch(0.96_0.035_90)_45%,oklch(0.95_0.04_250)_100%)] px-4 py-6 font-nunito">
      <div className="flex w-full max-w-[380px] flex-col items-center gap-5">
        ...
        <div className="flex w-full flex-col gap-[18px] rounded-[28px] border-2 border-[oklch(0.9_0.05_340)] bg-[oklch(0.99_0.015_340)] px-[26px] py-8 shadow-[0_10px_24px_oklch(0.7_0.08_340_/_0.25),0_2px_0_oklch(0.85_0.06_340_/_0.6)_inset]">
          <div className="flex flex-col gap-1 text-center">
            <div className="font-fredoka text-2xl font-semibold text-[oklch(0.42_0.14_340)]">Create a Host Account</div>
            <div className="text-sm font-semibold text-[oklch(0.52_0.05_340)]">Register to start hosting your own bee</div>
          </div>
