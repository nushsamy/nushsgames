  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={() => navigate("/")}
        className="flex cursor-pointer items-center gap-2.5 border-none bg-transparent p-0 font-display text-lg font-semibold text-[oklch(0.42_0.14_340)]"
      >
        <span className="text-[22px]">🔎</span>Murder Mystery Voter
      </button>
      {right && (
